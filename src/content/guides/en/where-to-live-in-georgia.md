...
<svg class="diagram" viewBox="0 0 640 250" role="img" aria-label="Choosing where to live in Georgia: capital city versus seaside city versus elsewhere.">
  <rect class="box box--key" x="230" y="10" width="180" height="48" rx="6"/>
  <text class="t-title" x="320" y="39" text-anchor="middle">Where will you settle?</text>

  <path class="edge" d="M320 58 L320 76 L110 76 L110 100"/>
  <path class="edge" d="M320 58 L320 88 L320 100"/>
  <path class="edge" d="M320 58 L320 76 L530 76 L530 100"/>
  <polygon class="arrow" points="110,108 105,98 115,98"/>
  <polygon class="arrow" points="320,108 315,98 325,98"/>
  <polygon class="arrow" points="530,108 525,98 535,98"/>

  <rect class="box" x="20" y="110" width="180" height="72" rx="6"/>
  <text class="t-title" x="110" y="135" text-anchor="middle">Tbilisi</text>
  <text class="t-sub" x="110" y="154" text-anchor="middle">capital, business &amp;</text>
  <text class="t-sub" x="110" y="168" text-anchor="middle">culture — year-round</text>

  <rect class="box" x="230" y="110" width="180" height="72" rx="6"/>
  <text class="t-title" x="320" y="135" text-anchor="middle">Batumi</text>
  <text class="t-sub" x="320" y="154" text-anchor="middle">Black Sea coast,</text>
  <text class="t-sub" x="320" y="168" text-anchor="middle">resort &amp; port — seasonal</text>

  <rect class="box" x="440" y="110" width="180" height="72" rx="6"/>
  <text class="t-title" x="530" y="135" text-anchor="middle">Elsewhere</text>
  <text class="t-sub" x="530" y="154" text-anchor="middle">Kutaisi, wine country,</text>
  <text class="t-sub" x="530" y="168" text-anchor="middle">mountain resorts</text>

  <text class="t-sub" x="320" y="215" text-anchor="middle">Most newcomers choose Tbilisi or Batumi. Rents are highest in central Tbilisi and on the Batumi seafront.</text>
</svg>
...
| --- | --- | --- |
| Role | Capital; business, culture, government | Resort city and Black Sea port |
| Approx. population (2024 census) | ~1.33 million | ~236,000 |
| Setting | Inland river valley | Black Sea coast |
| Climate | Hot summers, cool winters | Mild winters, warm humid summers, very wet |
...
For the practical side of finding a home and budgeting:

- **[Housing in Georgia: Renting and Buying](/en/housing-in-georgia)** — the two routes to a home and how each works.
- **[Cost of Living in Georgia](/en/cost-of-living-in-georgia)** — monthly budgets and typical rents by city and area.
