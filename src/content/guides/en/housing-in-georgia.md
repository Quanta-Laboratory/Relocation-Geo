...
<svg class="diagram" viewBox="0 0 640 250" role="img" aria-label="Choose between renting and buying a home in Georgia.">
  ...
  <text class="t-title" x="320" y="39" text-anchor="middle">Where will you live?</text>

  <path class="edge" d="M320 58 L320 78 L150 78 L150 100"/>
  <path class="edge" d="M320 58 L320 78 L490 78 L490 100"/>
  <polygon class="arrow" points="150,108 145,98 155,98"/>
  <polygon class="arrow" points="490,108 485,98 495,98"/>
  <text class="t-edge" x="150" y="94" text-anchor="middle">short-term / flexible</text>
  <text class="t-edge" x="490" y="94" text-anchor="middle">long-term / invest</text>

  <rect class="box" x="55" y="110" width="190" height="60" rx="6"/>
  <text class="t-title" x="150" y="135" text-anchor="middle">Rent a home</text>
  <text class="t-sub" x="150" y="154" text-anchor="middle">Civil Code lease, freely negotiated</text>

  <rect class="box" x="395" y="110" width="190" height="60" rx="6"/>
  <text class="t-title" x="490" y="135" text-anchor="middle">Buy property</text>
  <text class="t-sub" x="490" y="154" text-anchor="middle">any property except farmland</text>
