...
This guide explains what a FIZ company is, which taxes are exempt, the 4% payment on sales into the rest of Georgia, who the regime suits, how to set up, and its limits. It is **general information, not legal or tax advice** — confirm current rules and any figures with the **[Revenue Service](https://www.rs.ge/)** before relying on them.
...
| Tax | Treatment inside a FIZ |
| --- | --- |
| Profit (corporate income) tax | Profit from **permitted activity conducted in the zone** is **exempt** |
| VAT — foreign goods brought into the zone | **Exempt** |
| VAT — transactions within the zone | **Exempt** |
| Property tax | Property **located in the zone** is **exempt** |
| Import duty — foreign goods brought into the zone | **Exempt** |
| Import duty — zone-produced goods taken into the rest of Georgia | **Exempt** (but VAT applies on import — see below) |
| Personal income tax on employees | **Payable** by employees on the basis of an income declaration |
...
2. **Registering an enterprise inside that zone**, in line with Georgian company-registration rules and the operator's procedures. See **[registering a company in Georgia](/en/registering-a-company-in-georgia)** for the general framework.
