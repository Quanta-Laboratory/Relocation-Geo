...
faq:
  ...
  - q: "Is land taxed differently?"
    a: "Yes. Land tax is a separate charge. Agricultural land is taxed at a base rate per hectare (from GEL 5 to GEL 100 depending on administrative unit and land quality), and non-agricultural land at GEL 0.24 per square metre; both are adjusted by a local territorial coefficient of up to 150%. Individuals are liable for land they own or use as of 1 April of the tax year."
...
This guide summarises the framework as it stands in 2026. It is **general information, not legal or tax advice** — thresholds, rates and coefficients are periodically updated, so **confirm the current figures with the [Revenue Service](https://www.rs.ge/)** before relying on them.
...
- **immovable property** owned by the individual (including property received under lease from non-residents, and property leased out to others);
- **yachts, motor boats, aeroplanes and helicopters**;
- **motor cars** (from 2018).

## Property tax on companies and other entities

A **Georgian entity** — or a **foreign entity with taxable property in Georgia** — pays property tax at a rate of **up to 1%** on the **annual average residual (book) value** of:

- its **fixed assets** (except land), and
- its **investment property**,

including property that is **leased out**.

For **immovable property acquired before 2005**, the average residual value is multiplied by a **coefficient of between 1.5 and 3**, depending on the acquisition date.

## Land tax

**Land tax** is charged separately from property tax on buildings and assets. Rates are fixed and then adjusted by a **local territorial coefficient**:

| Land type | Base rate | Local adjustment |
| --- | --- | --- |
| Agricultural land | GEL 5 – GEL 100 per hectare (by administrative unit and land quality) | Territorial coefficient up to 150% |
| Non-agricultural land | GEL 0.24 per square metre | Territorial coefficient up to 150% |

Individuals pay land tax on land they **own or use as of 1 April** of the tax year — including state-owned land they use or possess, and (with limited exceptions) land registered to a deceased person that they own or use.

## Who declares and when

- A **natural person** pays property tax and land tax **no later than 15 November** of the calendar year, on the basis of a **declaration** filed with the Revenue Service.
- **Companies** follow the Tax Code's filing and payment rules for legal entities.

Because property tax is administered locally and the declaration is your responsibility, keep records of your property's value and your household income, and check the current deadlines and forms with the **Revenue Service**.
...
Property tax is separate from the tax you may pay when you **earn rental income** or **sell** property. For the taxation of individuals' income, including rental income, see **[personal income tax in Georgia](/en/personal-income-tax-georgia)**. If you are a non-resident buying real estate, see **[buying property in Georgia for foreigners](/en/buying-property-in-georgia-for-foreigners)**.

## Legal sources

This guide is based on the **Tax Code of Georgia** (property-tax and land-tax provisions), with cross-reference to PwC's Worldwide Tax Summaries for the individual and corporate summaries. Figures and coefficients are periodically updated, so **confirm the current position with the Revenue Service** before acting. This is general information, not legal or tax advice.
