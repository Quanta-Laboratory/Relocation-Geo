---
title: "Living in Tbilisi: A Guide for Newcomers"
category: "live"
...
sources:
  ...
  - name: "Tbilisi International Airport"
    url: "https://www.tbilisiairport.com/en-EN"
faq:
  - q: "How big is Tbilisi?"
    a: "Tbilisi is Georgia's largest city and capital. In the 2024 census it had about 1.33 million residents — roughly a third of the country's population — and it is the most densely populated part of Georgia (Geostat)."
  - q: "What is the weather like in Tbilisi?"
    a: "Tbilisi has a humid subtropical climate. Summers are hot and can exceed 35 °C, while winters are cool with occasional frost and light snow. The city sits in a river valley at roughly 380–770 metres, which can trap heat in summer. Spring and autumn are the mildest seasons."
  - q: "Which neighbourhoods do newcomers choose in Tbilisi?"
    a: "Common choices include Vake and Vera (leafy, central, popular with foreigners), Saburtalo (modern, well connected, near universities), Old Tbilisi (historic and central), and Didi Dighomi (newer, more affordable, further out). Each balances price, character and distance from the centre differently."
  - q: "How do you get around Tbilisi?"
    a: "Tbilisi has a two-line metro, an extensive bus network and widely used ride-hailing apps, all inexpensive. Tbilisi International Airport lies east of the city and connects to Europe, the Gulf and the region; a city bus and taxis link it to the centre. Fares and typical costs are covered in the cost-of-living guide."
  - q: "Who does Tbilisi suit best?"
...
Newcomers tend to concentrate in a handful of districts, each with a different balance of price, character and distance from the centre:

- **Vake** — a leafy, sought-after central district with parks, cafés and a long-standing foreign-resident presence; among the pricier areas.
- **Vera** — small, central and walkable, between the old town and Vake, popular for its cafés and access.
- **Saburtalo** — a large, modern district with good transport, universities and everyday amenities, generally more affordable than Vake.
- **Old Tbilisi** — the historic core, atmospheric and central, with a mix of restored and older housing.
- **Didi Dighomi** — a newer area further from the centre with more modern apartment stock and lower rents.
