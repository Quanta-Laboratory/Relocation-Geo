...
sources:
  ...
  - name: "Revenue Service of Georgia (customs and vehicle import)"
    url: "https://www.rs.ge/"
faq:
  - q: "Can I drive in Georgia on my foreign licence?"
    a: "Yes. A foreigner may drive on a valid foreign driving licence for up to one year after their last entry into Georgia (or until the licence expires, if sooner). An International Driving Permit alongside it is useful if your licence is not in Georgian or English."
  - q: "Can I exchange my foreign licence for a Georgian one?"
    a: "Yes. You can swap a valid foreign driving licence for a Georgian licence at the Service Agency without taking the local driving test; the foreign licence is surrendered to the Agency in the process."
  - q: "How long can I drive a car with foreign plates?"
    a: "You can use a foreign-registered car in Georgia for 90 days from crossing the border. After that you must either take it out of the country or complete a customs procedure — full import (clearance) or temporary admission."
  - q: "Do foreign cars need insurance in Georgia?"
