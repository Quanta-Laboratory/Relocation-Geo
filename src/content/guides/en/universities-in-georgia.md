...
## How Georgian higher education is structured

Higher education is governed by the Law of Georgia on Higher Education and follows the Bologna three-cycle model: bachelor's, master's and doctoral degrees, measured in ECTS credits. Institutions fall into three legal types — the **university** (offers all three cycles and conducts research), the **teaching university** (up to master's level), and the **college** (bachelor-level or short-cycle higher education). Both public (state) and private institutions operate within this framework.
...
Admission rules and education policy in Georgia are being reviewed, and conditions for international applicants can change between intakes. Always confirm the current authorisation status of the institution, the accreditation of your programme, and the admission requirements directly with the university and the NCEQE before committing.
