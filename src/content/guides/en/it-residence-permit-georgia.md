...
lang: en
summary: "Georgia's IT Residence Permit is a dedicated route for foreign IT professionals, founders and company representatives, and their family members. It is issued for three years and renewable. Three categories qualify — IT employees registered in the Ministry's labour-migration database, IT entrepreneurs holding Small Business Status, and representatives of international IT companies. Employees and entrepreneurs must show at least two years of IT experience and annual income of at least USD 25,000 (in GEL), received in at least two instalments 30 days apart. State fees are GEL 500 (90 days) or GEL 750 (60 days). This guide sets out the categories, tests, required documents, the IT-sector definition, fees and how to apply."
reviewed: 2026-07-10
checked: 2026-07-13
order: 10
sources:
  ...
  - name: Government of Georgia Resolution No. 520 of 1 September 2014 — Procedures for issuing residence permits (matsne)
...
faq:
  - q: How long is the IT Residence Permit valid?
    a: It is issued for three years and can be renewed in three-year increments (up to a maximum of twelve years in total), provided the conditions continue to be met. After that, holders who qualify can move to a permanent or indefinite permit on another basis.
  - q: Who can apply for the IT Residence Permit?
    a: "Three categories: foreign IT employees recorded in the Ministry of Labour's labour-migration database; IT entrepreneurs registered as Individual Entrepreneurs with Small Business Status whose activity is in IT; and managers or authorised representatives of international IT companies operating in Georgia. Their family members can apply on the same basis."
  - q: What income do I need to prove?
    a: At least USD 25,000 per year in Georgian lari equivalent (for the employee and entrepreneur categories). The income must have been received during the previous year in at least two payments, separated by intervals of at least 30 days, so a single lump sum is not enough. You also need at least two years of IT-related work or economic activity.
  - q: What documents do I need?
    a: It depends on your category, but generally an application (with your labour-migrant registration code where relevant), passport copy, proof of lawful stay, proof of two years' IT experience, an income certificate, a 3×4 photo and the fee receipt. Company representatives submit proof of authority; family members submit the main holder's permit and proof of relationship. Foreign documents must generally be apostilled/legalised and translated into Georgian and notarised.
  ...
  - q: How much does it cost and how long does it take?
    a: The standard review takes 90 days for a fee of GEL 500; an expedited 60-day review costs GEL 750. A Georgian ID (residence) card is issued separately, from GEL 60 (10 working days) up to GEL 150 (same day). Confirm current fees with the Public Service Development Agency.
tags:
  - RP
---

An **IT Residence Permit** is the residence permit granted to a **foreign citizen — and their family members — engaged in the information technology sector** in Georgia. Georgia created it to attract foreign software developers, IT founders and the staff of international technology companies, and it is popular with the remote-tech crowd because it is granted for a relatively long **three years** and recognises both employees and entrepreneurs.
...
If your work falls outside these classifications, check carefully before applying.
